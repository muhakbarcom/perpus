        ...
        <tr>
            ...
            <tr>
                ...
                <td style="text-align:center" width="200px">
                    <?php
                    echo anchor(site_url('kategori/read/' . $kategori->id), 'Read');
                    echo ' | ';
                    echo anchor(site_url('kategori/update/' . $kategori->id), 'Update');
                    echo ' | ';
                    echo anchor(site_url('kategori/delete/' . $kategori->id), 'Delete', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
                    ?>
                </td>
            </tr>
        <?php
