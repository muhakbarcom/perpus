        ...
        <tr>
            ...
            <tr>
                ...
                <td style="text-align:center" width="200px">
                    <?php
                    echo anchor(site_url('buku/read/' . $buku->id), 'Read');
                    echo ' | ';
                    echo anchor(site_url('buku/update/' . $buku->id), 'Update');
                    echo ' | ';
                    echo anchor(site_url('buku/delete/' . $buku->id), 'Delete', 'onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
                    ?>
                </td>
            </tr>
        <?php
